...
FILESEXTRAPATHS:prepend := "${THISDIR}/weston_10.0.2:"
...
SRC_URI:append:qcs615  = "  file://0001-drm-backend-power-off-during-hotplug-disconnect.patch \
                            file://0001-weston-add-sdm-option.patch"
SRC_URI:append:qcom = "   file://0001-remove-set_position.patch \
                          file://0001-remove-call-xdg_toplevel_set_position.patch"
SRC_URI:append:qcom = "   file://0001-HACK-Support-setting-surface-flags-activate-and-alph.patch "

DEPENDS:append:qcom-custom-bsp = " property-vault gbm qcom-libdmabufheap libxcursor cairo libxcb"
