...
static void lt9611uxc_assert_5v(struct lt9611uxc *lt9611uxc)
{
	...
	msleep(20);
	//if (lt9611uxc->switch_gpio)
	//	gpiod_set_value_cansleep(lt9611uxc->switch_gpio, 1);
}
...
static int lt9611uxc_gpio_init(struct lt9611uxc *lt9611uxc)
{
	...
	//lt9611uxc->switch_gpio = devm_gpiod_get_index_optional(dev, "enable", 1, GPIOD_OUT_LOW);
	//if (IS_ERR(lt9611uxc->switch_gpio)) {
	//	dev_err(dev, "failed to acquire switch gpio\n");
	//	return PTR_ERR(lt9611uxc->switch_gpio);
	//}
