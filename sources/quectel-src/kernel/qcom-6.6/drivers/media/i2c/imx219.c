 ...
 */
 ...
 static int imx219_set_ctrl(struct v4l2_ctrl *ctrl)
 {
	 ...
	 case V4L2_CID_ANALOGUE_GAIN:
		 cci_write(imx219->regmap, IMX219_REG_ANALOG_GAIN,
			   ctrl->val, &ret);
		 dev_info(&client->dev,"config V4L2_CID_ANALOGUE_GAIN ret=%d\n",ret);
		 break;
	 case V4L2_CID_EXPOSURE:
		 cci_write(imx219->regmap, IMX219_REG_EXPOSURE,
			   ctrl->val, &ret);
		 dev_info(&client->dev,"config V4L2_CID_EXPOSURE ret=%d\n",ret);
		 break;
	 case V4L2_CID_DIGITAL_GAIN:
		 cci_write(imx219->regmap, IMX219_REG_DIGITAL_GAIN,
			   ctrl->val, &ret);
		 dev_info(&client->dev,"config V4L2_CID_DIGITAL_GAIN ret=%d\n",ret);
		 break;
	 case V4L2_CID_TEST_PATTERN:
		 cci_write(imx219->regmap, IMX219_REG_TEST_PATTERN,
			   imx219_test_pattern_val[ctrl->val], &ret);
		 dev_info(&client->dev,"config V4L2_CID_TEST_PATTERN ret=%d\n",ret);
		 break;
	 case V4L2_CID_HFLIP:
	 case V4L2_CID_VFLIP:
		 cci_write(imx219->regmap, IMX219_REG_ORIENTATION,
			   imx219->hflip->val | imx219->vflip->val << 1, &ret);
		 dev_info(&client->dev,"config V4L2_CID_HFLIP/VFLIP ret=%d\n",ret);
		 break;
	 case V4L2_CID_VBLANK:
		 cci_write(imx219->regmap, IMX219_REG_VTS,
			   imx219->mode->height + ctrl->val, &ret);
		 dev_info(&client->dev,"config V4L2_CID_VBLANK ret=%d\n",ret);
		 break;
	 case V4L2_CID_TEST_PATTERN_RED:
		 cci_write(imx219->regmap, IMX219_REG_TESTP_RED,
			   ctrl->val, &ret);
		 dev_info(&client->dev,"config V4L2_CID_TEST_PATTERN_RED ret=%d\n",ret);
		 break;
	 case V4L2_CID_TEST_PATTERN_GREENR:
		 cci_write(imx219->regmap, IMX219_REG_TESTP_GREENR,
			   ctrl->val, &ret);
		 dev_info(&client->dev,"config V4L2_CID_TEST_PATTERN_GREENR ret=%d\n",ret);
		 break;
	 case V4L2_CID_TEST_PATTERN_BLUE:
		 cci_write(imx219->regmap, IMX219_REG_TESTP_BLUE,
			   ctrl->val, &ret);
		 dev_info(&client->dev,"config V4L2_CID_TEST_PATTERN_BLUE ret=%d\n",ret);
		 break;
	 case V4L2_CID_TEST_PATTERN_GREENB:
		 cci_write(imx219->regmap, IMX219_REG_TESTP_GREENB,
			   ctrl->val, &ret);
		 dev_info(&client->dev,"config V4L2_CID_TEST_PATTERN_GREENB ret=%d\n",ret);
		 break;
	 default:
		 dev_info(&client->dev,
	 ...
	 dev_info(&client->dev,"ctrl finished: ret=%d\n",ret);
	 return ret;
 }
				   ...
				   struct v4l2_subdev_state *state)
 {
	 ...
	 printk("imx219_start_streaming start");
	 ...
	 printk("imx219_start_streaming end");
	 return 0;
 ...
 static void imx219_stop_streaming(struct imx219 *imx219)
 {
	 ...
	 printk("imx219_stop_streaming start");
 ...
 static int imx219_set_stream(struct v4l2_subdev *sd, int enable)
 {
	 ...
	 struct v4l2_subdev_state *state;
	 int ret = 0;
	 printk("imx219_set_stream enable:%d",enable);
	 ...
	 if (enable) {
		 ...
		 printk("imx219_set_stream disable:%d",enable);
 ...
 static int imx219_power_off(struct device *dev)
 {
	...
	//  clk_disable_unprepare(imx219->xclk);
	 ...
	 printk("camera imx219 power off\n");	 
	 return 0;
 }
 ...
 static int __maybe_unused imx219_resume(struct device *dev)
 {
	 ...
	 printk("camera imx219 imx219_resume");
	 if (imx219->streaming) {
		 state = v4l2_subdev_lock_and_get_active_state(sd);
		 ret = imx219_start_streaming(imx219, state);
		 v4l2_subdev_unlock_state(state);
 ...
 static int imx219_check_hwcfg(struct device *dev, struct imx219 *imx219)
 {
	 ...
	 dev_info(dev,"imx219_check_hwcfg finished of imx219\n");
	 ret = 0;
 ...
 static int imx219_probe(struct i2c_client *client)
 {
	 ...
	 dev_info(dev, "xclk frequency : %d Hz\n",
		imx219->xclk_freq);
	 ...
	 imx219->power_gpio = devm_gpiod_get_optional(dev, "power",
							  GPIOD_OUT_HIGH);
	 dev_info(dev,"get pinctrl of imx219\n");
	 /*
