...
kernel void shdr_decompand_and_tm(
    ...
    float inverse_tone_perc_r_arg, float hdr_bayer_gtm_gamma, int short_offset,
    int long_offset_arg, __global const int* decomp_tbl, __global const int* comp_tbl, __global const float* slp, float knee_points_numb, float knee_strength, float max_compand_input_value
  ...
  FLOAT4 quad0_L, quad0_S, quad1_L, quad1_S, luma_q0;
