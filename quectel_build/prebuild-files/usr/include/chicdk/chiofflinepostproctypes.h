...
typedef void(*POSTPROCRESULTCALLBACK)(PostProcSessionParams* pSessionParams,
                                             uint32_t encodedSize, void* pUserData);
...
struct PostProcCreateParams
{
    ...
    POSTPROCRESULTCALLBACK  pResultCallBack; ///< Result call back from lib
